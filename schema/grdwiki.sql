...
--
-- Host: localhost    Database: grdwiki
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=658 DEFAULT CHARSET=binary;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=663 DEFAULT CHARSET=binary MAX_ROWS=10000000 AVG_ROW_LENGTH=1024;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `text` (
  ...
  PRIMARY KEY (`old_id`)
) ENGINE=InnoDB AUTO_INCREMENT=659 DEFAULT CHARSET=binary MAX_ROWS=10000000 AVG_ROW_LENGTH=10240;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=64 DEFAULT CHARSET=binary;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-09-29 15:59:00
