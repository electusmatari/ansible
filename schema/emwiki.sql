...
--
-- Host: localhost    Database: emwiki
-- ------------------------------------------------------
...
) ENGINE=MEMORY DEFAULT CHARSET=latin1 COLLATE=latin1_german2_ci MAX_ROWS=25000;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2581 DEFAULT CHARSET=utf8 MAX_ROWS=10000000 AVG_ROW_LENGTH=1024;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `searchindex` (
  ...
  `si_title` varchar(255) COLLATE latin1_german2_ci NOT NULL DEFAULT '',
  `si_text` mediumtext COLLATE latin1_german2_ci NOT NULL,
...
CREATE TABLE `text` (
  ...
  PRIMARY KEY (`old_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2555 DEFAULT CHARSET=utf8 MAX_ROWS=10000000 AVG_ROW_LENGTH=10240;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-09-29 15:58:53
